...
def test_token_count_callback(mock_optimizer):
    ...
    token_counts = {"input_tokens": 200, "output_tokens": 100, "total_tokens": 300}
    ...
    # Now exceed the max
    token_counts_over_limit = {"input_tokens": 400, "output_tokens": 100, "total_tokens": 500}  # Over the limit
    ...
    # Now exceed the max
    token_counts_over_limit = {"input_tokens": 200, "output_tokens": 200, "total_tokens": 400}  # Over the limit
    mock_optimizer.predictor.llm.get_token_count = MagicMock(return_value=token_counts_over_limit)
    ...
    callback = TokenCountCallback(max_tokens_for_termination=500, token_type_for_termination="total_tokens")
    ...
    # Now exceed the max
    token_counts_over_limit = {"input_tokens": 300, "output_tokens": 300, "total_tokens": 600}  # Over the limit
    mock_optimizer.predictor.llm.get_token_count = MagicMock(return_value=token_counts_over_limit)
