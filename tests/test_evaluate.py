"""Tests for promptolution.evaluate: train_test_split + evaluate()."""
...
def test_evaluate_scores_and_sorts():
    ...
    result = evaluate(["Classify the sentiment.", "Positive or negative?"], task, MarkerBasedPredictor(llm))
